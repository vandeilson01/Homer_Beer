         ...
         <div class="px-4 md:px-10 mx-auto w-full -m-34">
           ...
           <div class="flex flex-wrap mt-4">
             ...
             <div class="w-full mb-12 px-4">
                    <button data-modal-target="add-product" data-modal-toggle="add-product" class="flex  text-[black] m-1 pr-2 pl-2 bg-[#FFD000] hover:bg-[yellow] font-bold border border-[#FFD600] rounded   mb-4 float-right hover:bg-[yellow] font-semibold  py-2 px-4 ">
...
<!--  
                 ...
                 <div class="block w-full overflow-x-auto">
                         ...
                         <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <h1 class="text-2xl p-5">Lista de Produtos</h1>
                                 ...
                                 @foreach($produtos as $produto)
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <button id="{{ $produto->id }}" type="button" data-modal-target="edit-product" data-modal-toggle="edit-product"  class="edit-product font-medium bg-[black] text-[white] m-1 p-2 border border-[black] rounded dark:text-blue-500 hover:bg-[#002000]" href="">
                                                EDITAR
                                            </button>
                            
                                            <button type="button"  data-id="{{ $produto->id }}" class="delete del-product  text-[black] m-1 pr-2 pl-2 bg-[#FFD000] hover:bg-[yellow] font-bold border border-[#FFD600] rounded">
                                                APAGAR
                                            </button>
